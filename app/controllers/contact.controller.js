...
exports.create = async (req, res, next) => {
    ...
    try {
        ...
        return next(new ApiError(500, error.message || "An error occurred while creating the contact"));
    }
};
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        return next(
            new ApiError (500,error.message || `Error updating contact with id=${req.params.id}`)
        );
    }
};
